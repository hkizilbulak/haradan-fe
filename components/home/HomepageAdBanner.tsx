...
const BANNER_HEIGHT_DESKTOP = 160;
const BANNER_HEIGHT_MOBILE = 110;

/**
 * Anasayfa 'Öne Çıkan İlanlar' altındaki tam genişlikli yatay reklam afişi.
 * BO üzerinden eklenen görseli tam genişlikte yatay banner olarak render eder.
 */
  ...
  const content = (
    ...
    >
      <Image
        ...
        accessibilityLabel={banner.altText ?? banner.title ?? 'Reklam'}
      />
    </View>
  );
